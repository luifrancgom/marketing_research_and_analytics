...
-   Build a customer segmentation model by grouping the bike shops into clusters to suppor the marketing team 

Use the template `002_marketing_report_part-3.qmd` to build the marketing report. You can find the template to use in 2 locations. Choose the option of your preference:
