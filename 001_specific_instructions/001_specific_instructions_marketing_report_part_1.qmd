...
-   [https://github.com/luifrancgom/marketing_research_and_analytics/](https://github.com/luifrancgom/marketing_research_and_analytics/) > 000_packages_for_the_course > 001_script_install_packages.R
...
-   If you understand what is the meaning of **built from source locally** and you want to do this just install the following tools:
    ...
    -   For **Windows Users**: [https://cran.r-project.org/bin/windows/Rtools/](https://cran.r-project.org/bin/windows/Rtools/) > *Choose the RTools version according to your R version* (type `R.version` in the RStudio console if you don't remember the R version you have installed)
    
    -   For **Mac Users**: [https://mac.r-project.org/tools/](https://mac.r-project.org/tools/) > Tools > Mandatory tools > *Install the tools that are pointed out in this page*
...
-   [https://github.com/luifrancgom/marketing_research_and_analytics/](https://github.com/luifrancgom/marketing_research_and_analytics/) > 000_templates > 001_marketing_report_part-1.qmd
