...
-   Principal component analysis (PCA) and perceptual maps
    ...
    -   Recover the data that was reduced when focusing in the horizontal axis
...
![Various projections of cube above plane by Michael Horvath (aka Datumizer) 2021-05-10](../000_images/008_various_projections_of_cube_above_plane.png){width="300px" height="300px"}
...
-   Principal component analysis (PCA) and perceptual maps
    ...
    -   Recovering original centered and scaled data, $X$, using loadings, $L$,[^2] and scores, $S$

[^2]: $L$ is an orthogonal matrix, which means that $L$ is a real square matrix such that $L^tL = LL^t = I$ where $I$ is the identity matrix.
...
-   Principal component analysis (PCA) and perceptual maps
    ...
    -   A **biplot** represents visually the scores of the first, x-axis, and second, y-axis, of the principal components and the corresponding loadings both **scaled by a factor**[^3]
...
[^3]: For specific details check out `?stats:::biplot.prcomp`, `?ggbiplot::ggbiplot` and `?ggbiplot::get_SVD`

##

-   Principal component analysis (PCA) and perceptual maps

    -   Building a biplot using the package `ggbiplot`
...
-   To the [**R Core Team**](https://www.r-project.org/contributors.html), the creators of [**RStudio IDE**](https://posit.co/products/open-source/rstudio/), [**Quarto**](https://quarto.org/) and the authors and maintainers of the packages [**tidyverse**](https://CRAN.R-project.org/package=tidyverse), [**skimr**](https://CRAN.R-project.org/package=skimr), [**corrr**](https://CRAN.R-project.org/package=corrr), [**tidyheatmaps**](https://CRAN.R-project.org/package=tidyheatmaps) [**tidymodels**](https://CRAN.R-project.org/package=tidymodels), [**ggforce**](https://CRAN.R-project.org/package=ggforce), [**ggbiplot**](https://CRAN.R-project.org/package=ggbiplot) , [**imager**](https://CRAN.R-project.org/package=imager) and [**tinytex**](https://CRAN.R-project.org/package=tinytex) for allowing me to access these tools without paying for a license
