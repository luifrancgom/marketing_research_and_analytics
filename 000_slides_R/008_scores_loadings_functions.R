# This pair of functions were extracted from https://github.com/bryanhanson/LearnPCA/blob/master/vignettes/scores_loadings_functions.R
## I didn´t create this functions
## They are related to Vignette 04: Understanding Scores and Loadings from the LearnPCA package
### https://cran.r-project.org/web/packages/LearnPCA/index.html
